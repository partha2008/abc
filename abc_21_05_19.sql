...
INSERT INTO `abc_users` (`user_id`, `sponsor_id`, `first_name`, `last_name`, `email`, `password`, `mobile_no`, `address`, `city`, `district`, `post_code`, `state_id`, `nominee_info`, `nominee_relation`, `about_me`, `parent_id`, `status`, `last_login`, `date_added`, `date_modified`) VALUES
(1, 'abccs', 'ABC Care Solution', '', '', '', '', '', '', '0', '', 0, '', '', '', 0, 'Y', 0, 0, 0),
(2, 'ABC273035', 'Partha', 'Chowdhury', 'partha.freelancer.2015@gmail.com', 'jpVf6PtSLugefu4CQzkUjXv2AupiwtueWCxR2Q2mK/w=', '8981329979', 'test', 'test', 'test', '700122', 35, 'test', 'test', 'About me', 1, 'N', 1558379462, 1558340336, 1558379304);
