...
--
-- Table structure for table `abc_message`
--
...
--
-- Dumping data for table `abc_message`
--

INSERT INTO `abc_message` (`message_id`, `subject`, `message`, `user_id`, `date`) VALUES
(1, 'rt', 'ret', 7, 1560286250);
...
(7, 'ABC848526', 'Partha7', 'Chowdhury', '', 'HguK9ZnSyhsvrFWHIVJoKm7UEistMtkNbpOEUy2bOJ0=', 'tester@123', '8981329979', '81(40/3/10) Shibtala Road, Khelaghar Garden', 'Barrackpore', 'North 24 PGS', '700122', 35, 'test', 'test', '', '', '', '', 2000, 6, 'Y', 1560285309, 0, 1558521750, 0),
...
--
-- AUTO_INCREMENT for table `abc_message`
--
ALTER TABLE `abc_message`
