...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 04, 2019 at 05:31 PM
...
INSERT INTO `abc_users` (`user_id`, `sponsor_id`, `first_name`, `last_name`, `email`, `password`, `original_password`, `mobile_no`, `address`, `city`, `district`, `post_code`, `state_id`, `nominee_info`, `nominee_relation`, `about_me`, `parent_id`, `status`, `last_login`, `date_added`, `date_modified`) VALUES
...
(12, 'ABC310641', 'Partha', 'Chowdhury', '', 'HguK9ZnSyhsvrFWHIVJoKm7UEistMtkNbpOEUy2bOJ0=', 'tester@123', '8981329979', 'test', 'Barrackpore', 'North 24 PGS', '700122', 35, 'test', 'test', '', 11, 'N', 1559659142, 1558521750, 0);
